(ns uttt.start
  (:require [io.pedestal.app.protocols :as p]
            ...
            [uttt.behavior :as behavior]
            [uttt.rendering :as rendering]))
...
(defn create-app [render-config]
  (let [ ;; Build the application described in the map
        ...
        ;;
        ;; The file, app/src/uttt/rendering.cljs contains
    ...
    (p/put-message (:input app) {msg/type :create-game msg/topic [:ttt]
